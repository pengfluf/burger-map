...
export const FOURSQUARE_ID =
  'OMFSFKJ2VCAUJ2VUXLD3YCSVCAM4R0ECB2QHWM32MFAZJZEB';
export const FOURSQUARE_SECRET =
  'PA3ZRQFBPUT1X1O0BGBZDGPN3PAYWXK0OZHRGFJVFO4N0FQO';

export const GOOGLE_API_URL =
  'https://maps.googleapis.com/maps/api/js?key=AIzaSyDk-SZbgOovJvTafj7feDjxUIXUrW0L9vY&v=3.exp&libraries=geometry,drawing,places';
